...
export const LEVELS = [
  ...
  L(2, 'The Bend', {
    ...
    startGold: 180,
    waves: { count: 10, types: ['normal', 'fast'], hpMult: 3.4, bountyMult: 0.35, waveclearMult: 0.2 },
  }),
  L(3, 'A Touch of Magic', {                    // unlock: magic tower
    ...
    startGold: 200,
    waves: { count: 10, types: ['normal', 'fast', 'swarm'], swarmFrom: 4, hpMult: 3.55, bountyMult: 0.28, waveclearMult: 0.2 },
  }),
